...
- Step-by-step guidance with self-assessment scales
...
- Emergency messaging
- Connection to All-Mercy clinicians (booking, messaging, callback)
...
- All finalized UI/UX designs (Figma/Adobe XD mockups)
- Graphic assets (logos, icons, images, illustrations)
- Audio/video content for teachings and meditations
- Text and copy for all modules
- API credentials if integrating with existing telehealth portal
- Brand guidelines and style guide
- Content ready for launch (at least initial batch of teachings and meditations)

Development Specifications:

- Platforms: iOS and Android (React Native) or single platform as specified
- Hosting: Cloud solution (AWS, Google Cloud, or Azure) to be determined
- Compliance: HIPAA and health data protection standards
- Browsers (Admin Dashboard): Chrome, Safari, Firefox, Edge (latest versions)

Important Notes:

- Project starts upon receipt of deposit and all required assets
- Any delay in providing resources will extend the delivery timeline
- Major scope changes after approval may result in cost and timeline adjustments
...
- Secure and documented backend API
- Configured and optimized database
- Complete technical documentation
- Admin user guide
- Complete source code with intellectual property rights transferred
...
- Content creation (UI/UX design, videos, audio, copywriting)
- Cloud hosting and server fees
- Developer account fees (Apple Developer, Google Play)
- Post-launch maintenance (can be negotiated separately)
- End-user training
...
Based on budget and payment terms to be discussed
...
3. Client receives 2 revision cycles included per development phase
4. Additional revisions beyond included cycles will be quoted separately
5. Major scope changes may result in timeline and cost adjustments
6. 30 days technical support included post-launch
7. All source code and intellectual property rights transfer to client upon final delivery
8. Client responsible for App Store and Google Play account fees and compliance
9. Confidentiality and non-disclosure agreements will be signed before project start
10. Both parties agree to maintain professional communication and timely feedback
...
This document serves as a formal project quote and will become a binding agreement upon signature by both parties.
