        ...
        >
          <VStack space="md" className="w-full max-w-[420px]">
            <Image
              ...
              className="w-40 h-20 mx-auto mb-5"
              alt="Logo"
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormControl isInvalid={!!errors.email} size="md" isRequired>
                  ...
                  <Input size="md" className="rounded-lg border-jego-border">
                    <InputField
                      inputMode="email"
                ...
                <FormControl isInvalid={!!errors.password} size="md" isRequired>
                  <HStack className="justify-between">
                    ...
                    <Link
                      ...
                      className="underline text-jego-primary text-base"
                    >
                      Mot de passe oublié ?
                    </Link>
                  </HStack>
            ...
            <HStack space="sm">
              ...
              <Link
                href="/register"
                className="underline text-base text-jego-primary"
                replace
              >
                Créer un compte
              </Link>
