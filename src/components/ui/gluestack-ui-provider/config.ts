...
export const config = {
  light: vars({
    ...
    "--foreground": "65, 48, 48",
    "--card": "250, 250, 250",
    "--card-foreground": "65, 48, 48",
    "--popover": "250, 250, 250",
    "--popover-foreground": "65, 48, 48",
    "--primary": "231, 0, 11",
    "--primary-foreground": "254, 242, 242",
    "--secondary": "254, 242, 242",
    "--secondary-foreground": "231, 0, 11",
    "--muted": "249, 250, 251",
    "--muted-foreground": "106, 114, 130",
    "--accent": "255, 235, 235",
    "--accent-foreground": "82, 56, 56",
    "--destructive": "193, 0, 7",
    ...
    /* Primary */
    "--color-primary-0": "255 115 122",
    "--color-primary-50": "255 87 96",
    "--color-primary-100": "255 59 69",
    "--color-primary-200": "255 31 42",
    "--color-primary-300": "254 4 16",
    "--color-primary-400": "231 1 11",
    "--color-primary-500": "207 6 16",
    "--color-primary-600": "187 9 18",
    "--color-primary-700": "167 12 20",
    "--color-primary-800": "148 15 21",
    "--color-primary-900": "130 16 22",
    "--color-primary-950": "112 17 22",
    ...
    "--color-outline-100": "242 242 242",
    "--color-outline-200": "242 241 241",
    "--color-outline-300": "220 219 219",
    "--color-outline-400": "213 212 212",
    "--color-outline-500": "162 163 163",
    "--color-outline-600": "142 142 142",
    "--color-outline-700": "116 116 116",
    "--color-outline-800": "83 82 82",
    "--color-outline-900": "65 64 64",
    "--color-outline-950": "39 38 36",
  ...
  dark: vars({
    /* App theme */
    "--background": "35, 31, 31",
    "--foreground": "255, 229, 229",
    "--card": "34, 27, 27",
    "--card-foreground": "224, 231, 255",
    "--popover": "34, 27, 27",
    "--popover-foreground": "224, 231, 255",
    "--primary": "231, 0, 11",
    "--primary-foreground": "249, 250, 251",
    "--secondary": "49, 25, 23",
    "--secondary-foreground": "255, 162, 162",
    "--muted": "54, 38, 38",
    "--muted-foreground": "176, 156, 156",
    "--accent": "49, 25, 23",
    "--accent-foreground": "255, 226, 226",
