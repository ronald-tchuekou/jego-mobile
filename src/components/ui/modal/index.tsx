...
const modalContentStyle = tva({
  base: 'bg-card rounded-md overflow-hidden border border-border shadow-hard-2 p-6',
  parentVariants: {
    size: {
      xs: 'w-[60%] max-w-[360px]',
      sm: 'w-[70%] max-w-[420px]',
...
const modalCloseButtonStyle = tva({
  base: 'group/modal-close-button z-10 rounded data-[focus-visible=true]:web:bg-accent web:outline-0 cursor-pointer',
})
